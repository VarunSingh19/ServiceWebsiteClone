          ...
          <Container className="mt-5 ">
            <div className='d-flex align-items-center mb-3'>
              <button
                ...
                className={`mx-auto btn ${showSignIn ? 'active' : ''}`}
              >
                Sign In
              </button>
              <button
            ...
            <div
              className='d-flex align-items-center justify-content-center mb-3 pl-3'
              style={{ border: "2px solid #ccc", borderRadius: "8px", backgroundColor: "#FFFFFF" }}
            >
              <button
                style={{
                  border: "none",
